...
class TemplateEntityRow extends h {
    setConfig(config) {
        this.config = Object.assign({}, config);
        this.state = Object.assign({}, this.config);
            ...
            if (this.config[k] && hasTemplate(this.config[k])) {
                bind_template((res) => {
                    ...
                    if (typeof res === "string")
                        res = res.replace(LOCALIZE_PATTERN, (key) => this.hass.localize(key.substring(2, key.length - 1)) || key);
                    state[k] = res;
                    this.state = state;
    ...
    async firstUpdated() {
        ...
        const options = {
            hasHold: ((_a = this.config.hold_action) === null || _a === void 0 ? void 0 : _a.action) !== undefined,
            hasDoubleClick: ((_b = this.config.hold_action) === null || _b === void 0 ? void 0 : _b.action) !== undefined,
        };
    ...
    render() {
        ...
        const icon = this.state.icon !== undefined ? this.state.icon || "no:icon" : undefined;
        const image = this.state.image;
        const name = this.state.name !== undefined
            ? this.state.name
            : ((_a = base === null || base === void 0 ? void 0 : base.attributes) === null || _a === void 0 ? void 0 : _a.friendly_name) || (base === null || base === void 0 ? void 0 : base.entity_id);
        const secondary = this.state.secondary;
        const state = this.state.state !== undefined ? this.state.state : entity === null || entity === void 0 ? void 0 : entity.state;
        const active = this.state.active;
        if (active !== undefined) {
            entity.attributes.brightness = 255;
        }
        const thisStyles = window.getComputedStyle(this);
        const color = this.state.color !== undefined || active !== undefined
            ? (_b = this.state.color) !== null && _b !== void 0 ? _b : (active !== undefined && active
...
__decorate([
    e()
], TemplateEntityRow.prototype, "config", void 0);
__decorate([
    e()
], TemplateEntityRow.prototype, "hass", void 0);
__decorate([
    e()
], TemplateEntityRow.prototype, "state", void 0);
__decorate([
    e()
], TemplateEntityRow.prototype, "_action", void 0);
if (!customElements.get("template-entity-row")) {
    customElements.define("template-entity-row", TemplateEntityRow);
    console.info(`%cTEMPLATE-ENTITY-ROW ${pjson.version} IS INSTALLED`, "color: green; font-weight: bold", "");
}
